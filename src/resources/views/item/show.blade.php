...
@section('css')
<link rel="stylesheet" href="{{ asset('css/index.show') }}">
@endsection
...
<div class="show__body">
    ...
    <div class="show__data">
        ...
        @endif
        <div class="show__data-fav">いいね：{{ $item->likes_count ?? 0 }} / コメント：{{ $item->comments_count ?? 0 }}</div>
        <div class="show__purchase">購入手続きへ</div>
        <h2>商品説明</h2>
